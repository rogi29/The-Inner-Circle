...
(function() {
    ...
    $r.prototype = {
        ...
        {
            var elem = this.e;
            var padding = function(position){
                return parseInt(window.getComputedStyle(elem, null).getPropertyValue('padding-'+position));
            };

            return {left: padding('left'), right: padding('right'), top: padding('top'), bottom: padding('bottom')};
        },
